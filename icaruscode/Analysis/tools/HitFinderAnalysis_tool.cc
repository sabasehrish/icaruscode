...
namespace HitFinderAnalysis
{
    ////////////////////////////////////////////////////////////////////////
    //
    // Class:       HitFinderAnalysis
    // Module Type: producer
    // File:        HitFinderAnalysis.cc
    //
...
class HitFinderAnalysis : virtual public IHitEfficiencyHistogramTool
{
public:
    /**
     *  @brief  Constructor
     ...
     *  @param  pset
     */
    explicit HitFinderAnalysis(fhicl::ParameterSet const & pset);
...
///
void HitFinderAnalysis::configure(fhicl::ParameterSet const & pset)
{
...
//----------------------------------------------------------------------------
/// Begin job method.
void HitFinderAnalysis::initializeHists(art::ServiceHandle<art::TFileService>& tfs, const std::string& dirName)
{
...
void HitFinderAnalysis::initializeTuple(TTree* tree)
{
    fTree = tree;
...
void HitFinderAnalysis::clear() const
{
    fTPCVec.clear();
    fCryoVec.clear();
    fPlaneVec.clear();
...
void HitFinderAnalysis::fillHistograms(const art::Event& event) const
{
...
void HitFinderAnalysis::endJob(int numEvents)
{
    return;
}
    
DEFINE_ART_CLASS_TOOL(HitFinderAnalysis)
}
